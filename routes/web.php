...
Route::group(['middleware' => ['web','locale']], function() {
    ...
    Route::get('dat-ban', 'Frontend\ContactController@index2')->name('datban');
    Route::post('lien-he', 'Frontend\ContactController@postContact')->name('post_contact');
    // Route::get('thuong-hieu', 'Frontend\SearchController@index')->name('thuonghieu');
    Route::get('gioi-thieu/{slug}', 'Frontend\IntroController@index')->name('intro');
...
Route::group(['middleware' => ['adminLogin', 'web']], function() {
    ...
    Route::group(['prefix' => 'admin'], function() {
        ...
        Route::group(['prefix' => 'sethome'], function() {
            Route::get('', 'Admin\SethomeController@index')->name('admin.sethome');
            Route::post('sethome/update', 'Admin\SethomeController@update')->name('admin.sethome.update');
        });
        Route::group(['prefix' => 'setabout'], function() {
            Route::get('', 'Admin\SetaboutController@index')->name('admin.setabout');
            Route::post('setabout/update', 'Admin\SetaboutController@update')->name('admin.setabout.update');
        });
    });
});
