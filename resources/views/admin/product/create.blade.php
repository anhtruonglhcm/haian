                                ...
                                <div class="panel-body">
                                    ...
                                    enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Name product: </label>
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    id="editor2" value="">{{ old('description_en') }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <textarea class="form-control" placeholder="Meta_key"
                                                    name="meta_key_en" value="{{ old('meta_key_en') }}"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <textarea class="form-control" placeholder="Meta_Des"
                                                    name="meta_des_en" value="{{ old('meta_des_en') }}"></textarea>
                                                </div>
                                            </div>
                                        </div>
