                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    name="name_vi" value="{{ $cate_post->name_vi }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" placeholder="Name"
                                                    name="name_en" value="{{ $cate_post->name_en }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    name="description_vi" value="{{ $cate_post->description_vi }}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" placeholder="Miêu tả"
                                                    name="description_en" value="{{ $cate_post->description_en }}">
                                                </div>
                                            </div>
